...
little to interrupt the sentence. The type is set slightly smaller (0.9em), because the mono next
to the text face otherwise looks too big. Long identifiers may wrap (`overflow-wrap: anywhere`)
