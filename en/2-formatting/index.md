...
| [[en/2-formatting/04-links/index\|2.4 Links]] | wikilinks, jump targets, external links, aliases, embeds |
...
| [[en/2-formatting/09-diagrams/index\|2.9 Diagrams]] | Mermaid: fourteen kinds of diagram on six pages |
| [[en/2-formatting/10-footnotes/index\|2.10 Footnotes]] | footnotes, variants, comments |
| [[en/2-formatting/11-properties/index\|2.11 Properties]] | frontmatter, data types, display |
| [[en/2-formatting/12-media/index\|2.12 Media]] | images, sizes, video, audio, documents, embeds |
| [[en/2-formatting/13-special/index\|2.13 Odds and ends]] | HTML, escapes, arrows, emoji |

What is **not** a Markdown page — bases, canvas and Excalidraw — stands in
...
— the callout colours, for instance. That does not stand here but in
