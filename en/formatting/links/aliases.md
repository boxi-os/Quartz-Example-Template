...
An example with several aliases: [[en/examples/alias|A page with an alias]].
...
> way and nothing else — see [[en/design/multilingual/linking|How the two languages find each
> other]].
