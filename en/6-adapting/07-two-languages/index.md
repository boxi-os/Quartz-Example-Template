...
| Part | Where |
| --- | --- |
| Detection and linking | [[en/6-adapting/07-two-languages/linking\|How the two languages find each other]] |
| The switcher in the header | [[en/5-design/01-navigation/language-switcher\|The language switcher]] |
| What stays monolingual | [[en/6-adapting/07-two-languages/limits\|Where the two languages stop]] |
