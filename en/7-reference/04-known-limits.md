...
| On a folder page the graph shows a single dot, even when the page has links — a bug in the plugin | the backlinks below show the same connections | [[en/5-design/04-beside-the-content/graph\|The graph]] |
