...
These 16 variables are read by `aside-graph.scss`. They can be changed in the app under *Styles → Variables* — without a line of CSS.
...
| `--tpl-radius-lg` | `14px` | Search, Link preview |
