...
Eine Quartz-Website besteht aus **Komponenten**: dem Explorer, der Suche, dem Inhaltsverzeichnis,
den Brotkrumen, der Fußzeile — jede von einem Plugin gebaut, jede mit einem eigenen Aussehen.
...
Ein **Stylesheet** ist die Datei, in der das Aussehen beschrieben ist — in der Sprache CSS, hier in
ihrer Erweiterung SCSS. Diese Vorlage hat 30 davon, eins je Komponente, und jede Seite hier nennt
...
| --- | --- |
| [[5-gestaltung/01-navigation/index\|5.1 Navigation]] | Explorer, Suche, Farbschema, Lesemodus, Kopfbereich, Fußzeile, Sprachumschalter |
| [[5-gestaltung/02-ueber-dem-inhalt/index\|5.2 Über dem Inhalt]] | Brotkrumen, Titel und Datum, Eigenschaften, Tags |
| [[5-gestaltung/03-im-inhalt/index\|5.3 Im Inhalt]] | Fließtext, Callouts, Code, Tabellen und Medien |
| [[5-gestaltung/04-neben-dem-inhalt/index\|5.4 Neben dem Inhalt]] | Inhaltsverzeichnis, Rückverweise, Graph, Zuletzt geändert |
...
Schriften, Variablen, Seitenraster, Barrierefreiheit — ist Kapitel [[6-anpassen/index|6 Anpassen]].
