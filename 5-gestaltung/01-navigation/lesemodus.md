...
Diese 10 Variablen liest `nav-reader-mode.scss`. Ändern lassen sie sich in der App unter *Stile → Variablen* — ohne eine Zeile [[7-nachschlagen/01-glossar#CSS und SCSS|CSS]].
...
| `--tpl-icon` | `1.1rem` | Farbschema-Umschalter, [[7-nachschlagen/01-glossar#Explorer\|Explorer]] |
