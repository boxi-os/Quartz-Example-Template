...
| [[3-obsidian-formate/index\|3 – Obsidian-Formate]] | Was wird aus einer [[7-nachschlagen/01-glossar#Base\|Base]], einem [[7-nachschlagen/01-glossar#Canvas\|Canvas]], einer Zeichnung? |
...
eigenen Obsidian-Vault, auf den das Projekt per [[7-nachschlagen/01-glossar#Symlink|Symlink]] zeigt — wer hier etwas ändert, ändert es an
